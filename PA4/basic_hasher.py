...
import time
from BIOINFO_M260B.helpers1 import read_reads, read_reference, pretty_print_aligned_reads_with_ref


def trivial_algorithm(reads, ref):
    """
...
if __name__ == "__main__":
    ...
    reference_fn = join(input_folder, '{}_strains.txt'.format(data_folder))
    reference = read_reference(reference_fn)[0]
